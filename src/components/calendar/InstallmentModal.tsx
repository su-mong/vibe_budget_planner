...
import type { MonthlyInstallment } from '../../types/budget';

export function InstallmentModal() {
  const { state, dispatch } = useBudget();
  const isOpen = state.modalState.type === 'installment';
  ...
  const handleSubmit = async () => {
    ...
    dispatch({ type: 'ADD_INSTALLMENT', installment: newInstallment });
    handleClose();
  };
  ...
  return (
    <Modal open={isOpen} onClose={handleClose} title="할부 납부 입력">
